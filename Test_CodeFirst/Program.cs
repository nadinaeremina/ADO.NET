...
namespace Exam
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            event_con.Date_ = new DateTime(2024, 06, 21, 18, 00, 00);
            event_con.place = place_1;
            event_con.Description_ = "Левша";
            event_con.Min_age = 7;
            ...
            */
            ...
            clients.Add(new Client_model("Галина", "Любимова", "Ивановна", "alt16@mail.ru", new DateTime(1990, 04, 12)));
            clients.Add(new Client_model("Надежда", "Половинкина", "Ивановна", "alt17@mail.ru", new DateTime(2001, 04, 12)));
            clients.Add(new Client_model("Дарья", "Шилова", "Ивановна", "alt18@mail.ru", new DateTime(2020, 04, 12)));
            ...
            clients.Add(new Client_model("Альберт", "Соколов", "Иванович", "alt32@mail.ru", new DateTime(2020, 04, 12)));
            ...
            clients.Add(new Client_model("Петр", "Петров", "Иванович", "alt52@mail.ru", new DateTime(2020, 04, 12)));
            ...
            clients.Add(new Client_model("Мария", "Лузина", "Ивановна", "alt55@mail.ru", new DateTime(2014, 04, 12)));
            ...
            clients.Add(new Client_model("Николай", "Вовин", "Иванович", "alt58@mail.ru", new DateTime(2014, 04, 12)));
            ...
            clients.Add(new Client_model("Николай", "Сахов", "Иванович", "alt65@mail.ru", new DateTime(2014, 04, 12)));
            clients.Add(new Client_model("Иван", "Молотов", "Иванович", "alt66@mail.ru", new DateTime(2014, 04, 12)));
            ...
            clients.Add(new Client_model("Мария", "Кожова", "Ивановна", "alt70@mail.ru", new DateTime(2020, 04, 12)));
            ...
            clients.Add(new Client_model("Николай", "Самин", "Иванович", "alt95@mail.ru", new DateTime(2014, 04, 12)));
            ...
            clients.Add(new Client_model("Петр", "Пулин", "Иванович", "alt112@mail.ru", new DateTime(2014, 04, 12)));
            ...
            clients.Add(new Client_model("Елена", "Русова", "Ивановна", "alt131@mail.ru", new DateTime(2014, 04, 12)));
            ...
            */
            ...
            ev_con.Add(new Event_content_model(2, new DateTime(2024, 07, 22, 17, 00, 00), 2, "Дон Кихот", 10, 800, 650));
            ev_con.Add(new Event_content_model(3, new DateTime(2024, 07, 23, 15, 00, 00), 3, "Князь Игорь", 14, 900, 850));
            ev_con.Add(new Event_content_model(4, new DateTime(2024, 06, 24, 14, 00, 00), 34, "Очарованный странник", 14, 500, 500));
            ev_con.Add(new Event_content_model(5, new DateTime(2024, 06, 20, 17, 30, 00), 35, "Евгений Онегин", 18, 400, 400));
            ev_con.Add(new Event_content_model(6, new DateTime(2024, 06, 21, 21, 00, 00), 36, "Мастер и Маргарита", 18, 500, 450));
            ev_con.Add(new Event_content_model(7, new DateTime(2024, 06, 25, 19, 30, 00), 67, "Женитьба", 18, 600, 300));
            ev_con.Add(new Event_content_model(8, new DateTime(2024, 06, 25, 15, 00, 00), 68, "Собачье сердце", 14, 800, 750));
            ev_con.Add(new Event_content_model(9, new DateTime(2024, 06, 25, 14, 00, 00), 69, "Тетка Чарли", 14, 900, 900));
            ev_con.Add(new Event_content_model(10, new DateTime(2024, 06, 25, 16, 30, 00), 98, "Головлевы", 14, 300, 300));
            ev_con.Add(new Event_content_model(4, new DateTime(2024, 06, 24, 13, 00, 00), 99, "Тетка Чарли", 14, 500, 450));
            ev_con.Add(new Event_content_model(5, new DateTime(2024, 06, 20, 12, 00, 00), 100, "Мастер и Маргарита", 18, 400, 350));
            ev_con.Add(new Event_content_model(11, new DateTime(2024, 06, 20, 16, 20, 00), 4, "Сурганова и оркестр", 14, 1700, 1650));
            ev_con.Add(new Event_content_model(12, new DateTime(2024, 06, 21, 17, 15, 00), 5, "Хор Турецкого", 14, 1000, 1000));
            ev_con.Add(new Event_content_model(13, new DateTime(2024, 06, 22, 17, 10, 00), 6, "Рок-острова", 14, 1500, 1450));
            ev_con.Add(new Event_content_model(14, new DateTime(2024, 06, 23, 10, 10, 00), 37, "Акустический блюз", 14, 900, 850));
            ev_con.Add(new Event_content_model(15, new DateTime(2024, 06, 24, 18, 20, 00), 38, "Латиноамериканские ритмы", 14, 2000, 2000));
            ev_con.Add(new Event_content_model(16, new DateTime(2024, 06, 25, 20, 15, 00), 39, "Милен фармер", 10, 3000, 2500));
            ev_con.Add(new Event_content_model(17, new DateTime(2024, 06, 26, 14, 00, 00), 70, "Пол Маккартни", 18, 2500, 2500));
            ev_con.Add(new Event_content_model(18, new DateTime(2024, 07, 26, 15, 00, 00), 71, "Симфонический оркестр", 14, 2000, 1150));
            ev_con.Add(new Event_content_model(19, new DateTime(2024, 06, 28, 12, 00, 00), 72, "Стас Михайлов", 14, 2100, 2000));
            ev_con.Add(new Event_content_model(13, new DateTime(2024, 06, 22, 10, 00, 00), 101, "Симфонический оркестр", 14, 1500, 1400));
            ev_con.Add(new Event_content_model(14, new DateTime(2024, 06, 23, 17, 30, 00), 102, "Пол Маккартни", 18, 900, 900));
            ev_con.Add(new Event_content_model(15, new DateTime(2024, 06, 24, 15, 00, 00), 103, "Акустический блюз", 14, 2000, 1500));
            ev_con.Add(new Event_content_model(20, new DateTime(2024, 06, 21, 20, 00, 00), 7, "Библиотеки служат людям", 7, 100, 50));
            ev_con.Add(new Event_content_model(21, new DateTime(2024, 06, 22, 17, 00, 00), 8, "Мистическая африка", 7, 200, 200));
            ev_con.Add(new Event_content_model(22, new DateTime(2024, 06, 21, 14, 00, 00), 9, "Александр сергеевич Пушкин", 10, 100, 100));
            ev_con.Add(new Event_content_model(23, new DateTime(2024, 06, 23, 12, 00, 00), 40, "Вижу космос", 7, 150, 100));
            ev_con.Add(new Event_content_model(24, new DateTime(2024, 06, 24, 17, 00, 00), 41, "Давайте просто любить жизнь!", 7, 50, 50));
            ev_con.Add(new Event_content_model(25, new DateTime(2024, 06, 25, 16, 00, 00), 42, "У победы наши лица", 10, 80, 80));
            ev_con.Add(new Event_content_model(26, new DateTime(2024, 06, 26, 15, 00, 00), 73, "Каникулы с книгой", 5, 100, 100));
            ev_con.Add(new Event_content_model(27, new DateTime(2024, 06, 26, 14, 30, 00), 74, "Образы России", 5, 200, 150));
            ev_con.Add(new Event_content_model(28, new DateTime(2024, 07, 26, 13, 00, 00), 75, "Сердце не камень", 5, 200, 150));
            ev_con.Add(new Event_content_model(29, new DateTime(2024, 06, 27, 12, 00, 00), 104, "Лето красное встречаем", 7, 100, 50));
            ev_con.Add(new Event_content_model(30, new DateTime(2024, 06, 27, 15, 00, 00), 105, "Россия - моя история", 14, 100, 100));
            ev_con.Add(new Event_content_model(31, new DateTime(2024, 06, 28, 16, 00, 00), 106, "История ВДВ", 14, 90, 50));
            ev_con.Add(new Event_content_model(32, new DateTime(2024, 06, 28, 17, 00, 00), 105, "Высшие ценности царской семьи", 14, 120, 120));
            ev_con.Add(new Event_content_model(33, new DateTime(2024, 06, 29, 16, 00, 00), 106, "Тайны ледяного материка", 7, 180, 180));
            ev_con.Add(new Event_content_model(34, new DateTime(2024, 06, 22, 21, 00, 00), 10, "Антигравитация", 5, 1700, 1650));
            ev_con.Add(new Event_content_model(35, new DateTime(2024, 06, 21, 21, 00, 00), 11, "Легенда", 5, 2000, 1650));
            ev_con.Add(new Event_content_model(36, new DateTime(2024, 06, 23, 14, 00, 00), 12, "Матрешка", 3, 2000, 2000));
            ev_con.Add(new Event_content_model(37, new DateTime(2024, 06, 24, 16, 00, 00), 43, "Грани Георгия Гараняна", 7, 3000, 2500));
            ev_con.Add(new Event_content_model(38, new DateTime(2024, 06, 25, 16, 00, 00), 44, "Шоу зверей", 7, 2500, 2500));
            ev_con.Add(new Event_content_model(39, new DateTime(2024, 06, 26, 16, 00, 00), 45, "Идол-2024", 10, 2000, 2000));
            ev_con.Add(new Event_content_model(40, new DateTime(2024, 06, 26, 16, 00, 00), 76, "Кудзинов", 14, 2500, 1650));
            ev_con.Add(new Event_content_model(41, new DateTime(2024, 07, 27, 16, 00, 00), 76, "Как создать вселенную", 5, 2000, 1950));
            ev_con.Add(new Event_content_model(42, new DateTime(2024, 06, 27, 16, 00, 00), 76, "Карнавал магии", 3, 2000, 2000));
            ev_con.Add(new Event_content_model(43, new DateTime(2024, 06, 28, 16, 00, 00), 107, "Артист", 3, 2500, 2400));
            ev_con.Add(new Event_content_model(44, new DateTime(2024, 06, 28, 16, 00, 00), 107, "Дурацкий цЫрк", 3, 2000, 2000));
            ev_con.Add(new Event_content_model(45, new DateTime(2024, 06, 29, 16, 00, 00), 107, "Гарри и школа волшебства", 3, 2000, 2000));
            ev_con.Add(new Event_content_model(46, new DateTime(2024, 06, 29, 16, 00, 00), 10, "Империя хищников", 7, 2400, 2400));
            ev_con.Add(new Event_content_model(47, new DateTime(2024, 06, 30, 16, 00, 00), 11, "Волшебная лампа", 3, 2200, 2200));
            ev_con.Add(new Event_content_model(48, new DateTime(2024, 06, 30, 16, 00, 00), 12, "Цирк-шапито", 3, 1700, 1650));
            ev_con.Add(new Event_content_model(49, new DateTime(2024, 06, 29, 16, 00, 00), 109, "Ледниковый период", 3, 1500, 1500));
            ev_con.Add(new Event_content_model(50, new DateTime(2024, 06, 20, 16, 00, 00), 13, "Турнир по боксу", 7, 1700, 1650));
            ev_con.Add(new Event_content_model(51, new DateTime(2024, 06, 21, 16, 00, 00), 14, "Футбольная лига", 7, 700, 650));
            ev_con.Add(new Event_content_model(52, new DateTime(2024, 06, 22, 16, 00, 00), 15, "Плавание", 7, 500, 500));
            ev_con.Add(new Event_content_model(53, new DateTime(2024, 06, 23, 16, 00, 00), 46, "Профессиональный бокс", 10, 1300, 650));
            ev_con.Add(new Event_content_model(54, new DateTime(2024, 06, 24, 16, 00, 00), 47, "Шоу каскадеров", 10, 1000, 1000));
            ev_con.Add(new Event_content_model(55, new DateTime(2024, 06, 25, 16, 00, 00), 48, "Фехтование", 10, 900, 650));
            ev_con.Add(new Event_content_model(56, new DateTime(2024, 07, 19, 16, 00, 00), 77, "Борьба на поясах", 10, 800, 800));
            ev_con.Add(new Event_content_model(57, new DateTime(2024, 06, 26, 16, 00, 00), 78, "Легкая атлетика", 7, 700, 650));
            ev_con.Add(new Event_content_model(58, new DateTime(2024, 06, 27, 16, 00, 00), 79, "Фигурное катание", 7, 700, 650));
            ev_con.Add(new Event_content_model(59, new DateTime(2024, 06, 27, 16, 00, 00), 108, "Хоккей", 7, 700, 650));
            ev_con.Add(new Event_content_model(60, new DateTime(2024, 06, 28, 16, 00, 00), 109, "Биатлон", 7, 700, 700));
            ev_con.Add(new Event_content_model(61, new DateTime(2024, 07, 28, 16, 00, 00), 110, "Формула-1", 7, 700, 700));
            ev_con.Add(new Event_content_model(62, new DateTime(2024, 06, 29, 16, 00, 00), 13, "Шахматы", 5, 700, 650));
            ev_con.Add(new Event_content_model(63, new DateTime(2024, 06, 29, 16, 00, 00), 14, "Теннис", 5, 700, 650));
            ev_con.Add(new Event_content_model(64, new DateTime(2024, 06, 30, 16, 00, 00), 15, "Велоспорт", 5, 700, 700));
            ev_con.Add(new Event_content_model(65, new DateTime(2024, 06, 30, 16, 00, 00), 46, "Летние виды спорта", 7, 700, 650));
            ev_con.Add(new Event_content_model(66, new DateTime(2024, 06, 30, 16, 00, 00), 48, "Зимние виды спорта", 7, 700, 650));
            ev_con.Add(new Event_content_model(67, new DateTime(2024, 06, 21, 16, 00, 00), 16, "Биохакинг", 18, 70, 65));
            ev_con.Add(new Event_content_model(68, new DateTime(2024, 06, 22, 16, 00, 00), 17, "Курс по управлению командой", 18, 65, 65));
            ev_con.Add(new Event_content_model(69, new DateTime(2024, 07, 23, 16, 00, 00), 18, "Бизнес-конференция", 18, 60, 60));
            ev_con.Add(new Event_content_model(70, new DateTime(2024, 06, 24, 16, 00, 00), 49, "Гипноз без гипноза", 18, 50, 50));
            ev_con.Add(new Event_content_model(71, new DateTime(2024, 06, 25, 16, 00, 00), 50, "Нейротехнология блоков", 18, 40, 40));
            ev_con.Add(new Event_content_model(72, new DateTime(2024, 07, 19, 16, 00, 00), 51, "Торговля и складской учет", 18, 30, 25));
            ev_con.Add(new Event_content_model(73, new DateTime(2024, 06, 26, 16, 00, 00), 80, "Методист онлайн-курсов", 18, 20, 20));
            ev_con.Add(new Event_content_model(74, new DateTime(2024, 06, 27, 16, 00, 00), 81, "Нейросети для каждого", 18, 25, 25));
            ev_con.Add(new Event_content_model(75, new DateTime(2024, 06, 27, 16, 00, 00), 82, "Кредиторская задолженность", 18, 30, 30));
            ev_con.Add(new Event_content_model(76, new DateTime(2024, 06, 28, 16, 00, 00), 111, "Построение системы управления", 18, 40, 40));
            ev_con.Add(new Event_content_model(77, new DateTime(2024, 06, 28, 16, 00, 00), 112, "Школа продаж", 14, 35, 35));
            ev_con.Add(new Event_content_model(78, new DateTime(2024, 06, 29, 16, 00, 00), 113, "Маркетинговая воронка", 18, 20, 20));
            ev_con.Add(new Event_content_model(79, new DateTime(2024, 06, 29, 16, 00, 00), 16, "Система менеджмента", 18, 25, 15));
            ev_con.Add(new Event_content_model(80, new DateTime(2024, 06, 30, 16, 00, 00), 17, "Аренда и лизинг", 18, 30, 30));
            ev_con.Add(new Event_content_model(81, new DateTime(2024, 06, 30, 16, 00, 00), 18, "Искусство управлять собой", 14, 40, 40));
            ev_con.Add(new Event_content_model(82, new DateTime(2024, 06, 30, 16, 00, 00), 111, "Бизнес-аналитик", 18, 45, 45));
            ev_con.Add(new Event_content_model(83, new DateTime(2024, 06, 29, 16, 00, 00), 112, "Семинар для психологов", 18, 50, 45));
            ev_con.Add(new Event_content_model(84, new DateTime(2024, 07, 19, 16, 00, 00), 19, "Головоломка", 7, 200, 150));
            ev_con.Add(new Event_content_model(85, new DateTime(2024, 06, 22, 16, 00, 00), 20, "Унесенные прзраками", 10, 100, 50));
            ev_con.Add(new Event_content_model(86, new DateTime(2024, 06, 23, 16, 00, 00), 21, "Тур с Иванушками", 5, 150, 50));
            ev_con.Add(new Event_content_model(87, new DateTime(2024, 06, 24, 16, 00, 00), 52, "Три богатыря", 3, 100, 50));
            ev_con.Add(new Event_content_model(88, new DateTime(2024, 06, 25, 16, 00, 00), 53, "10 жизней", 7, 250, 150));
            ev_con.Add(new Event_content_model(89, new DateTime(2024, 06, 26, 16, 00, 00), 54, "Манюня", 5, 200, 50));
            ev_con.Add(new Event_content_model(90, new DateTime(2024, 06, 27, 16, 00, 00), 83, "Непослушники", 14, 200, 150));
            ev_con.Add(new Event_content_model(91, new DateTime(2024, 07, 18, 16, 00, 00), 84, "Семейный переполох", 18, 250, 250));
            ev_con.Add(new Event_content_model(92, new DateTime(2024, 06, 29, 16, 00, 00), 85, "Майор Гром", 18, 150, 150));
            ev_con.Add(new Event_content_model(93, new DateTime(2024, 06, 30, 16, 00, 00), 114, "Бар МоскваЧики", 18, 100, 100));
            ev_con.Add(new Event_content_model(94, new DateTime(2024, 07, 29, 16, 00, 00), 115, "Заклятье", 18, 150, 150));
            ev_con.Add(new Event_content_model(95, new DateTime(2024, 06, 28, 16, 00, 00), 116, "Фуриоса", 14, 200, 150));
            ev_con.Add(new Event_content_model(96, new DateTime(2024, 06, 28, 16, 00, 00), 116, "Мой любимый чемпион", 10, 200, 150));
            ev_con.Add(new Event_content_model(97, new DateTime(2024, 06, 29, 16, 00, 00), 115, "Бывший в помощь", 18, 100, 100));
            ev_con.Add(new Event_content_model(98, new DateTime(2024, 07, 30, 16, 00, 00), 114, "Горизонты", 10, 200, 200));
            ev_con.Add(new Event_content_model(99, new DateTime(2024, 06, 27, 16, 00, 00), 19, "Только течет река", 10, 200, 200));
            ev_con.Add(new Event_content_model(100, new DateTime(2024, 07, 28, 19, 00, 00), 20, "Клуб Зеро", 10, 100, 50));
            ev_con.Add(new Event_content_model(101, new DateTime(2024, 06, 21, 19, 00, 00), 22, "Импровизация", 18, 300, 250));
            ev_con.Add(new Event_content_model(102, new DateTime(2024, 06, 22, 19, 00, 00), 23, "Уральские пельмени", 104, 400, 350));
            ev_con.Add(new Event_content_model(103, new DateTime(2024, 06, 23, 19, 00, 00), 24, "Вечерний Ургант", 18, 200, 200));
            ev_con.Add(new Event_content_model(104, new DateTime(2024, 06, 24, 19, 00, 00), 55, "Однажды в России", 18, 100, 100));
            ev_con.Add(new Event_content_model(105, new DateTime(2024, 06, 25, 19, 00, 00), 56, "Прожекторперисхилтон", 18, 200, 200));
            ev_con.Add(new Event_content_model(106, new DateTime(2024, 06, 26, 19, 00, 00), 57, "КВН", 14, 300, 300));
            ev_con.Add(new Event_content_model(107, new DateTime(2024, 06, 27, 19, 00, 00), 86, "Камеди клаб", 18, 400, 400));
            ev_con.Add(new Event_content_model(108, new DateTime(2024, 06, 28, 19, 00, 00), 87, "Камеди вумен", 18, 150, 150));
            ev_con.Add(new Event_content_model(109, new DateTime(2024, 06, 29, 19, 00, 00), 88, "Городок", 14, 250, 150));
            ev_con.Add(new Event_content_model(110, new DateTime(2024, 06, 30, 19, 00, 00), 117, "Гле логика?", 14, 350, 250));
            ev_con.Add(new Event_content_model(111, new DateTime(2024, 06, 30, 19, 00, 00), 118, "ХБ", 18, 100, 50));
            ev_con.Add(new Event_content_model(112, new DateTime(2024, 06, 29, 19, 00, 00), 119, "Большой вопрос", 14, 150, 50));
            ev_con.Add(new Event_content_model(113, new DateTime(2024, 07, 18, 19, 00, 00), 22, "Камеди Батл", 18, 200, 150));
            ev_con.Add(new Event_content_model(114, new DateTime(2024, 06, 25, 19, 00, 00), 23, "Большая разница", 18, 250, 150));
            ev_con.Add(new Event_content_model(115, new DateTime(2024, 06, 27, 19, 00, 00), 24, "Убойной ночи", 18, 300, 250));
            ev_con.Add(new Event_content_model(116, new DateTime(2024, 07, 28, 19, 00, 00), 55, "Смеяться разрешается", 14, 240, 150));
            ev_con.Add(new Event_content_model(117, new DateTime(2024, 07, 28, 19, 00, 00), 56, "Кривое зеркало", 18, 140, 140));
            ev_con.Add(new Event_content_model(118, new DateTime(2024, 06, 29, 19, 00, 00), 57, "Открытый микрофон", 18, 90, 90));
            ev_con.Add(new Event_content_model(119, new DateTime(2024, 06, 30, 19, 00, 00), 86, "Смехопанарама", 14, 100, 100));
            ev_con.Add(new Event_content_model(120, new DateTime(2024, 06, 30, 19, 00, 00), 87, "Петросян-шоу", 14, 100, 100));
            ev_con.Add(new Event_content_model(121, new DateTime(2024, 07, 21, 19, 00, 00), 25, "Танцплощадка", 18, 1700, 1650));
            ev_con.Add(new Event_content_model(122, new DateTime(2024, 06, 22, 19, 00, 00), 26, "Дискотека 90-х", 18, 900, 850));
            ev_con.Add(new Event_content_model(123, new DateTime(2024, 06, 23, 19, 00, 00), 27, "День рождения андрея Резника", 14, 500, 500));
            ev_con.Add(new Event_content_model(124, new DateTime(2024, 06, 24, 19, 00, 00), 58, "Вечеринка Ретро", 14, 600, 600));
            ev_con.Add(new Event_content_model(125, new DateTime(2024, 06, 25, 19, 00, 00), 59, "Дыхание ночи", 18, 700, 650));
            ev_con.Add(new Event_content_model(126, new DateTime(2024, 07, 26, 19, 00, 00), 89, "Выпускной", 18, 800, 650));
            ev_con.Add(new Event_content_model(127, new DateTime(2024, 06, 27, 19, 00, 00), 90, "Для своих", 18, 900, 650));
            ev_con.Add(new Event_content_model(128, new DateTime(2024, 06, 27, 19, 00, 00), 120, "Вечер Ивана купала", 18, 1200, 950));
            ev_con.Add(new Event_content_model(129, new DateTime(2024, 07, 28, 19, 00, 00), 121, "Баварские радости", 18, 1100, 1100));
            ev_con.Add(new Event_content_model(130, new DateTime(2024, 07, 19, 19, 00, 00), 28, "Король Лев", 3, 70, 65));
            ev_con.Add(new Event_content_model(131, new DateTime(2024, 06, 23, 19, 00, 00), 29, "Винни Пух", 3, 60, 60));
            ev_con.Add(new Event_content_model(132, new DateTime(2024, 06, 24, 19, 00, 00), 30, "Волшебник Изумрудного города", 5, 50, 50));
            ev_con.Add(new Event_content_model(133, new DateTime(2024, 07, 25, 19, 00, 00), 61, "Золушка", 7, 80, 65));
            ev_con.Add(new Event_content_model(134, new DateTime(2024, 06, 26, 19, 00, 00), 61, "Парк чудес", 7, 90, 65));
            ev_con.Add(new Event_content_model(135, new DateTime(2024, 06, 27, 19, 00, 00), 62, "Счастливый принц", 5, 100, 100));
            ev_con.Add(new Event_content_model(136, new DateTime(2024, 06, 28, 19, 00, 00), 63, "Красная шапочка", 3, 100, 100));
            ev_con.Add(new Event_content_model(137, new DateTime(2024, 06, 28, 19, 00, 00), 92, "Кто сказал Мяу?", 3, 90, 90));
            ev_con.Add(new Event_content_model(138, new DateTime(2024, 06, 29, 19, 00, 00), 92, "Тридевятое царство", 5, 80, 80));
            ev_con.Add(new Event_content_model(139, new DateTime(2024, 07, 29, 19, 00, 00), 93, "Апельсиновые сказки", 3, 70, 65));
            ev_con.Add(new Event_content_model(140, new DateTime(2024, 07, 18, 19, 00, 00), 93, "Музейные занятия для детей", 5, 60, 60));
            ev_con.Add(new Event_content_model(141, new DateTime(2024, 06, 30, 19, 00, 00), 94, "Динопарк", 3, 50, 50));
            ev_con.Add(new Event_content_model(142, new DateTime(2024, 06, 29, 19, 00, 00), 123, "Муравей по имени Бигги", 5, 50, 50));
            ev_con.Add(new Event_content_model(143, new DateTime(2024, 06, 29, 19, 00, 00), 124, "Мышонок Криспи", 5, 70, 65));
            ev_con.Add(new Event_content_model(144, new DateTime(2024, 06, 30, 19, 00, 00), 125, "Сказка в Лукоморье", 7, 60, 60));
            ev_con.Add(new Event_content_model(145, new DateTime(2024, 06, 28, 19, 00, 00), 125, "Лев и мышка-никудышка", 7, 70, 65));
            ev_con.Add(new Event_content_model(146, new DateTime(2024, 06, 24, 19, 00, 00), 31, "Ни дать, ни зять", 18, 700, 650));
            ev_con.Add(new Event_content_model(147, new DateTime(2024, 06, 25, 19, 00, 00), 32, "Научи меня жить", 14, 700, 650));
            ev_con.Add(new Event_content_model(148, new DateTime(2024, 06, 26, 19, 00, 00), 33, "Скрипач на крыше", 10, 500, 500));
            ev_con.Add(new Event_content_model(149, new DateTime(2024, 06, 27, 19, 00, 00), 64, "Не в свои сани не садись", 10, 400, 400));
            ev_con.Add(new Event_content_model(150, new DateTime(2024, 06, 28, 19, 00, 00), 65, "Одолжите тенора", 18, 350, 250));
            ev_con.Add(new Event_content_model(151, new DateTime(2024, 07, 29, 19, 00, 00), 95, "Декабристы", 18, 700, 650));
            ev_con.Add(new Event_content_model(152, new DateTime(2024, 06, 29, 19, 00, 00), 96, "Девушка на миллион", 18, 800, 800));
            ev_con.Add(new Event_content_model(153, new DateTime(2024, 06, 30, 19, 00, 00), 126, "Жизель", 18, 500, 450));
            ev_con.Add(new Event_content_model(154, new DateTime(2024, 06, 30, 19, 00, 00), 127, "Иммерсивный театр", 18, 500, 500));
            ev_con.Add(new Event_content_model(154, new DateTime(2024, 07, 19, 19, 00, 00), 127, "Иммерсивный театр", 18, 500, 500));
            ...
            */
            ...
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 06, 21), 235, 85));
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 06, 21), 230, 106));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 06, 21), 230, 105));
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 06, 21), 220, 132));
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 06, 21), 220, 140));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 06, 21), 220, 142));
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 07, 18), 231, 85))    ;
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 07, 17), 229, 106));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 07, 16), 228, 105));
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 07, 16), 227, 132));
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 07, 17), 226, 140));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 07, 18), 225, 142));
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 07, 18), 231, 85));
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 07, 17), 229, 106));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 07, 16), 228, 106));
            buy.Add(new Buy_tickets_model(2700, new DateTime(2024, 07, 16), 227, 105));
            buy.Add(new Buy_tickets_model(2800, new DateTime(2024, 07, 17), 226, 105));
            buy.Add(new Buy_tickets_model(2900, new DateTime(2024, 07, 18), 225, 105));
